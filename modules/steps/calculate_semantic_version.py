        ...
        for i, service in pipeline_data_utils.get_enumerated_services(pipeline_data):
            ...
            if image_data[data_defs.IMG_IS_SEMVER] and image_data[data_defs.IMG_TAGS]:
                try:
                    ...
                    raise exceptions.DeploymentError("No matching version found for '{}': '{}'  in the Docker registry. Not pushed yet?".format(image_data[data_defs.IMG_SEMVER_ENV_KEY], image_data[data_defs.IMG_SEMVER_VERSION]))
